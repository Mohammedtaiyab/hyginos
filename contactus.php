...
<div id=seofy_infobox_60657eeee314d class="seofy_module_infobox type_default layout_left infobox_alignment_left "><div class="infobox_wrapper"><div class="infobox_icon_wrapper"  style="margin-right:25px; "><div class="infobox_icon_container" style="width:50px; height:50px; "><i class="infobox_icon flaticon-map"  style="font-size:25px;"></i></div></div><div class="infobox_content_wrapper"><h3 class="infobox_title"  style="font-size:18px; font-weight:700; margin-bottom:0px; ">Visit Us (India):</h3><div class="infobox_content" style="font-size:18px; ">Sector-9, Rohini Delhi</div></div></div></div><div  class ="seofy_module_spacing"><div class="spacing_size spacing_size-initial" style="height:21px;"></div></div>  
<div id=seofy_infobox_60657eeee3509 class="seofy_module_infobox type_default layout_left infobox_alignment_left "><div class="infobox_wrapper"><div class="infobox_icon_wrapper"  style="margin-right:25px; "><div class="infobox_icon_container" style="width:50px; height:50px; "><i class="infobox_icon flaticon-map"  style="font-size:25px;"></i></div></div><div class="infobox_content_wrapper"><h3 class="infobox_title"  style="font-size:18px; font-weight:700; margin-bottom:0px; ">Visit Us (Canada):</h3><div class="infobox_content" style="font-size:18px; "> 6 Bottomwood Street Brampton Ontario</div></div></div></div><div  class ="seofy_module_spacing"><div class="spacing_size spacing_size-initial" style="height:21px;"></div></div>  
<div id=seofy_infobox_60657eeee3892 class="seofy_module_infobox type_default layout_left infobox_alignment_left "><div class="infobox_wrapper"><div class="infobox_icon_wrapper"  style="margin-right:25px; "><div class="infobox_icon_container" style="width:50px; height:50px; "><i class="infobox_icon flaticon-mail"  style="font-size:25px;"></i></div></div><div class="infobox_content_wrapper"><h3 class="infobox_title"  style="font-size:18px; font-weight:700; margin-bottom:0px; ">Mail Us:</h3><div class="infobox_content" style="font-size:18px; ">Hyginos@gmail.com</div></div></div></div><div  class ="seofy_module_spacing"><div class="spacing_size spacing_size-initial" style="height:21px;"></div></div>  
